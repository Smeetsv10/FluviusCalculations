...
class FluviusData:
    def __init__(self, file_name='P6269_Open_Data_EV_met_ZP.csv', file_path=None, start_date=None, end_date=None):
        if file_path is None:
            ...
            self.EAN_ID = 1201  # Specific user ID to filter data for (None means random)
        else:
